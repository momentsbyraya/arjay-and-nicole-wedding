...
const Entourage = () => {
  ...
  const officiantRef = useRef(null)
  ...
  useEffect(() => {
    ...
    // Officiant - collect (single row)
    if (officiantRef.current) {
      const officiantNames = officiantRef.current.querySelectorAll('p.font-poppins')
      if (officiantNames.length > 0) {
        gsap.set(officiantNames, { opacity: 0, y: 20 })
        allNameRows.push({ elements: Array.from(officiantNames), time: currentTime })
        currentTime += 0.2
      }
    }

    // Principal Sponsors - collect rows (after Parents)
    if (principalSponsorsRef.current) {
      ...
      if (ninongElements && ninongElements.length > 0) {
        const maxLength = Math.max(ninongElements.length, ninangElements?.length || 0)
    ...
    // Ring, Flower, Coin, Bible bearers (matches on-page order)
    const bearerRefs = [ringBearerRef, flowerBoysRef, coinBearerRef, bibleBearerRef].filter(ref => ref.current)
    ...
    // Veil, Cord, Candle sponsors (matches on-page order)
    const sponsorRefs = [veilSponsorsRef, cordSponsorsRef, candleSponsorsRef].filter(ref => ref.current)
  ...
  const cleanParentName = (name) => name?.replace(/\blate\b\.?\s*/i, '').trim() || ''
  ...
  return (
    <>
      ...
      <section
        ...
        className="relative w-full overflow-hidden px-6 py-32 sm:py-40 md:py-44 lg:py-52 bg-[#485A6E]"
        style={{ 
          opacity: 0, 
      ...
      >
        ...
        <div className="relative z-20 flex items-center justify-center py-12">
          <div className="max-w-xs sm:max-w-md lg:max-w-4xl w-full mx-auto px-4 sm:px-6 md:px-6 lg:px-8 py-10">
            {/* Header Section */}
            <div className="text-center mb-12">
              <h2 ref={headerRef} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-8">
                ...
                <div className="flex flex-col items-center justify-center">
                  {/* Groom's Name */}
                  <div>
                    <p className="font-tebranos text-4xl sm:text-5xl md:text-6xl lg:text-7xl uppercase leading-tight text-white">
                      {couple.groom.firstName}
                    </p>
                    <p className="font-ballet text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight -mt-4 text-white">
                      {couple.groom.lastName}
                    </p>
                  </div>
                  <p className="caudex-bold text-base sm:text-lg md:text-xl lg:text-2xl uppercase leading-tight my-1 text-white">
                    AND
                  </p>
                  {/* Bride's Name */}
                  <div>
                ...
                {/* NUPTIALS */}
                <div className="caudex-bold text-base sm:text-lg md:text-xl lg:text-2xl block leading-none uppercase mt-8 text-white" style={{ lineHeight: '0.8' }}>
                  NUPTIALS
                </div>
              </h2>
            </div>
            ...
            <div ref={parentsRef} className="mb-6 flex flex-row gap-4 sm:gap-6 justify-center items-center">
              ...
              <div className="flex-1">
                <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-right uppercase text-gold-300 tracking-wide drop-shadow-sm">Groom's Parents</p>
                <p className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase whitespace-nowrap overflow-hidden text-ellipsis text-right text-white">{entourage.parents.groom.father}</p>
                <p className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase whitespace-nowrap overflow-hidden text-ellipsis text-right text-white">{entourage.parents.groom.mother}</p>
              </div>

              {/* Bride's Parents */}
              <div className="flex-1">
                <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-left uppercase text-gold-300 tracking-wide drop-shadow-sm">Bride's Parents</p>
                <p className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase whitespace-nowrap overflow-hidden text-ellipsis text-left text-white">{cleanParentName(entourage.parents.bride.father)}</p>
                <p className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase whitespace-nowrap overflow-hidden text-ellipsis text-left text-white">{cleanParentName(entourage.parents.bride.mother)}</p>
              </div>
            </div>

            {/* Officiant */}
            <div ref={officiantRef} className="mb-6 flex flex-col items-center justify-center">
              <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Officiant</p>
              <p className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white whitespace-nowrap overflow-hidden text-ellipsis text-center">
                John Peter Valenzuela
              </p>
            </div>
            ...
            {principalSponsors && (() => {
              ...
              return (
                <div ref={principalSponsorsRef} className="mb-6">
                  <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl imperial-script-regular mb-6 text-center capitalize whitespace-nowrap text-white">Principal Sponsors</h3>
                  <div className="flex flex-row gap-4 sm:gap-6 justify-center items-start">
                    <div className="flex-1">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-right uppercase text-gold-300 tracking-wide drop-shadow-sm">Ninong</p>
                      <div className="space-y-2">
                        {ninongs.map((name, index) => (
                          <p key={index} className="ninong-item text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white text-right whitespace-nowrap overflow-hidden text-ellipsis">
                            {name}
                          </p>
                        ))}
                      </div>
                    ...
                    <div className="flex-1">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-left uppercase text-gold-300 tracking-wide drop-shadow-sm">Ninang</p>
                      <div className="space-y-2">
                        {pairedNinangs.map((name, index) => (
                          <p key={index} className="ninang-item text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white text-left whitespace-nowrap overflow-hidden text-ellipsis">
                            {name}
                          </p>
                        ))}
                      </div>
                    ...
                    <div className="mt-4 flex justify-center">
                      <div className="space-y-2">
                        {unpairedNinangs.map((name, index) => (
                          <p key={`unpaired-${index}`} className="ninang-item text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white text-center whitespace-nowrap overflow-hidden text-ellipsis">
                            {name}
                          </p>
                        ))}
                      </div>
            ...
            <div className="mb-6 flex flex-row gap-4 sm:gap-6 justify-center items-center">
              {bestman && (
                <div ref={bestmanRef} className="flex-1">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-right uppercase text-gold-300 tracking-wide drop-shadow-sm">Bestman</p>
                  {bestman.names && bestman.names.map((name, index) => (
                    <p key={index} className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white whitespace-nowrap overflow-hidden text-ellipsis text-right">
                      {name}
                    </p>
                  ))}
                </div>
              ...
              {maidOfHonor && (
                <div ref={maidOfHonorRef} className="flex-1">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-left uppercase text-gold-300 tracking-wide drop-shadow-sm">Maid Of Honor</p>
                  {maidOfHonor.names && maidOfHonor.names.map((name, index) => (
                    <p key={index} className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white whitespace-nowrap overflow-hidden text-ellipsis text-left">
                      {name}
                    </p>
                  ))}
                </div>
            ...
            {/* Secondary: groomsmen, bearers, then veil / cord / candle */}
            {secondarySponsors && (
              <div ref={secondarySponsorsRef} className="mb-6">
                <div className="flex flex-row gap-4 sm:gap-6 justify-center items-start mb-8">
                  <div className="flex-1">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-right uppercase text-gold-300 tracking-wide drop-shadow-sm">Groomsmen</p>
                    <div className="space-y-2">
                      {secondarySponsors.groomsmen && secondarySponsors.groomsmen.map((name, index) => (
                        <p key={index} className="groomsmen-item text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white text-right whitespace-nowrap overflow-hidden text-ellipsis">
                          {name}
                        </p>
                      ))}
                    </div>
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-left uppercase text-gold-300 tracking-wide drop-shadow-sm">Bridesmaids</p>
                    <div className="space-y-2">
                      {secondarySponsors.bridesmaid && secondarySponsors.bridesmaid.map((name, index) => (
                        <p key={index} className="bridesmaids-item text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white text-left whitespace-nowrap overflow-hidden text-ellipsis">
                          {name}
                        </p>
                      ))}
                    </div>
                ...
                {(ringBearer || flowerBoys || coinBearer || bibleBearer) && (
                  <div className="mb-8">
                    <div className="flex flex-col gap-6 justify-center items-center">
                      {ringBearer && (
                        <div ref={ringBearerRef}>
                          <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Ring Bearer</p>
                          {ringBearer.names && ringBearer.names.map((name, index) => (
                            <p key={index} className="text-[8.5px] sm:text-[12px] md:text-[14px] lg:text-[16px] font-poppins uppercase text-white whitespace-nowrap overflow-hidden text-ellipsis text-center">
                              {name}
                            </p>
                          ))}
                        </div>
                      ...
                      {flowerBoys && (
                        <div ref={flowerBoysRef}>
                          <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Flower Girls</p>
                      ...
                      {coinBearer && (
                        <div ref={coinBearerRef}>
                          <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Coin Bearer</p>
                      ...
                      {bibleBearer && (
                        <div ref={bibleBearerRef}>
                          <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Bible Bearer</p>
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl imperial-script-regular mb-6 text-center capitalize whitespace-nowrap text-white">Secondary Sponsors</h3>
                ...
                <div className="flex flex-col gap-6 justify-center items-center mb-6">
                  {veilSponsors && (
                    <div ref={veilSponsorsRef} className="flex flex-col gap-2 justify-center items-center">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Veil Sponsors</p>
                  ...
                  {cordSponsors && (
                    <div ref={cordSponsorsRef} className="flex flex-col gap-2 justify-center items-center">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Cord Sponsors</p>
                  ...
                  {candleSponsors && (
                    <div ref={candleSponsorsRef} className="flex flex-col gap-2 justify-center items-center">
                      <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Candle Sponsors</p>
            ...
            {juniorFlowerGirls && (
              <div className="mb-6">
                <div ref={juniorFlowerGirlsRef} className="flex flex-col gap-2 justify-center items-center mt-6">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Junior Flower Girls</p>
            ...
            {littleFlowerGirls && (
              <div className="mb-6">
                <div ref={littleFlowerGirlsRef} className="flex flex-col gap-2 justify-center items-center mt-6">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Little Flower Girls</p>
            ...
            {hereComesTheBride && (
              <div className="mb-6">
                <div ref={hereComesTheBrideRef} className="flex flex-col gap-2 justify-center items-center mt-6">
                  <p className="text-[10px] sm:text-[13px] md:text-[15px] lg:text-[17px] caudex-bold font-bold mb-2 whitespace-nowrap text-center uppercase text-gold-300 tracking-wide drop-shadow-sm">Here comes the bride</p>
