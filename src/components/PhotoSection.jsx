  ...
  return (
    <div ref={photoSectionRef} className="relative w-full pt-32 pb-12 overflow-hidden">
      ...
      {texts.length > 0 && (
        ...
        >
          <p 
            className="font-handwritten text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-brand-dark whitespace-nowrap"
            style={{
              position: 'absolute',
              top: '5%',
              left: '-5%',
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto px-4">
          ...
          {displayImages[0] && (
            ...
            >
              ...
              <div className="p-2 text-center">
                <div className="text-sm sm:text-lg text-brand-dark font-handwritten">
        ...
        {/* Paragraph */}
        {paragraph && (
          <p className="text-base sm:text-lg font-albert font-thin text-neutral-dark text-center max-w-xl mx-auto leading-relaxed">
            {paragraph}
          </p>
        )}
      </div>
