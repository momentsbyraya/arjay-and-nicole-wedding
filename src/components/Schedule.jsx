  ...
  return (
    <div className="relative program-section">
      ...
      <div ref={scheduleTitleRef} className="relative z-10 mb-12 sm:mb-16 program-title-container">
        ...
        <p className="text-sm sm:text-base md:text-lg font-albert text-current opacity-95 text-center mt-4 mx-auto px-4 program-description">
                ...
                <div key={index} className="relative">
                  {isWeddingDay ? (
                    <div className="relative flex items-center justify-center">
                      <svg 
                        className="w-20 h-20 sm:w-24 sm:h-24 text-brand-light drop-shadow-[0_1px_2px_rgb(0_0_0_/_25%)]"
                        viewBox="0 0 100 100"
                    ...
                    <div 
                      className={`flex items-center justify-center rounded-lg border border-white/50 ${isBesideHeart ? 'w-12 h-12 sm:w-14 sm:h-14' : 'w-10 h-10 sm:w-12 sm:h-12'}`}
                    >
      ...
      <div ref={timelineRef} className="relative max-w-md sm:max-w-xl lg:max-w-2xl w-full mx-auto z-10 timeline-container">
        ...
        <div ref={lineRef} className="absolute left-1/2 top-0 bottom-0 w-px bg-white/40 transform -translate-x-1/2"></div>
        ...
        <div ref={eventsRef} className="space-y-12 sm:space-y-16 md:space-y-20 lg:space-y-24">
           {scheduleData.events.map((event, index) => {
            ...
            <div className="w-1/2 pr-6 text-right flex flex-col justify-center">
              ...
              <div className="border-b border-dashed border-white/40 opacity-80 mb-1"></div>
